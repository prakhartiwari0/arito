...
const result_heading = document.querySelector(".result_heading");
...
function resultGenerator() {
	...
	percent_obtained.textContent = `${(
		...
		if (percent_obtained.innerText > 50) 
			result_heading.innerText = "Hurray 😊";
		else 
		result_heading.innerText = "Better Luck Next time 🤞";
